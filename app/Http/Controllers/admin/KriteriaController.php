...
class KriteriaController extends Controller
{
    ...
    {
        $data = ModelsKriteria::allKriteria();
    ...
    {
        try {
            ModelsKriteria::create($request->validated());
    ...
    public function edit(Request $request)
    {
        ...
        $id = $request->session()->get('edit_kriteria_id');
    ...
    public function update(KriteriaRequest $request, ModelsKriteria $Kriteria): RedirectResponse
    {
        try {
